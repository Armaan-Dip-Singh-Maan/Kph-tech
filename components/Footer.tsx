        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <div className="flex gap-2">
              {socialLinks.map((s) => (
                <SocialIcon key={s.id} href={s.url}>
        ...
        <div className="mt-10 border-t border-[#4a5b82] pt-6">
          <div className="flex flex-col items-center justify-between gap-4 text-sm text-white/80 md:flex-row">
            ...
            <div className="flex gap-6">
              <a href={privacyUrl} className="transition hover:text-white">
                Privacy Policy
              </a>
              <a href={termsUrl} className="transition hover:text-white">
                Terms of Service
              </a>
              <a href={cookieUrl} className="transition hover:text-white">
                Cookie Policy
              </a>
            </div>
          </div>
